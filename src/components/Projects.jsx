...
const ProjectCard = ({
  ...
  return (
    <motion.div
      ...
      h-[420px] cursor-pointer card-shadow transition-all duration-300 hover:scale-105`}
      ...
      {active !== id ? (
        ...
        <>
          <div
            ...
            flex-col bg-gradient-to-t from-slate-900/90 via-slate-800/70 to-transparent
            ...
            <h2
              ...
              text-white uppercase font-beckman sm:mt-0 -mt-[1rem] drop-shadow-lg">
              {name}
            </h2>
            <p
              className="text-gray-200 sm:text-[14px] text-[12px] 
              max-w-3xl sm:leading-[24px] leading-[18px]
              font-poppins tracking-[1px] drop-shadow-md">
              {description}
            </p>
            <button
